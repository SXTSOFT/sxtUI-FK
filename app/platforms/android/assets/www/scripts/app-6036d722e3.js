...
(function(){
  ...
  SzgcyhydController.$inject = ["api", "$stateParams", "$rootScope", "$sec"];
  angular
    .module('app.szgc')
...
(function ()
{
  ...
  sxtProjectsJdDirective.$inject = ["$timeout", "api", "$q"];
  angular
    .module('app.szgc')
...
(function(){
  ...
  sxtImageViewDirective.$inject = ["$rootScope", "api", "$q"];
  angular
    .module('app.szgc')
...
$templateCache.put("app/main/szgc/home/link.html","<md-content flex=\"\" layout=\"column\" ng-show=\"!vm.searBarHide\" class=\"menu-toggle-list\"><sxt-projects-jd ng-model=\"vm.project.pid\" object-scope=\"vm\" region-type=\"vm.project.type\" region-name=\"vm.project.typeName\" project-id=\"vm.project.projectId\" project-name=\"vm.project.projectName\" id-tree=\"vm.project.idTree\" name-tree=\"vm.project.nameTree\"><div class=\"md-padding\" layout=\"row\"><md-button type=\"submit\" ng-disabled=\"vm.project.type!=64\" flex=\"\" ng-click=\"vm.yhyd()\" class=\"md-raised md-primary\">确定</md-button></div></sxt-projects-jd></md-content><md-content flex=\"\" layout=\"column\" ng-show=\"vm.searBarHide\"><iframe flex=\"\" ng-src=\"http://vkde.sxtsoft.com/yhyd/\"></iframe><div style=\"position: absolute; top:0px; right:0px;\"><toggle-menu inst=\"vm.searBarHide\"></toggle-menu></div></md-content>");
...
$templateCache.put("app/toolbar/layouts/content-with-footbar/toptoolbar.html","<div class=\"md-toolbar-tools\"><md-icon md-font-icon=\"icon-chevron-left\" style=\"color:white;\" ng-click=\"goBack();\" class=\"icon s32\"></md-icon><h2><span>{{$root.title || \'万科数字工程\'}}</span></h2><div style=\"position: absolute;top:5px;right:5px;\"><md-progress-circular id=\"toolbar-progress\" ng-if=\"$root.loadingProgress\" md-mode=\"indeterminate\" md-diameter=\"40\"></md-progress-circular></div></div>");
