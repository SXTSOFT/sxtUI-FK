...
define('echarts/component/visualMapContinuous', ['require', '../echarts', './visualMap/preprocessor', './visualMap/typeDefaulter', './visualMap/visualEncoding', './visualMap/ContinuousModel', './visualMap/ContinuousView', './visualMap/visualMapAction'], function (require) {
...
define('echarts/component/visualMapPiecewise', ['require', '../echarts', './visualMap/preprocessor', './visualMap/typeDefaulter', './visualMap/visualEncoding', './visualMap/PiecewiseModel', './visualMap/PiecewiseView', './visualMap/visualMapAction'], function (require) {
    require('../echarts').registerPreprocessor(require('./visualMap/preprocessor'));
    require('./visualMap/typeDefaulter');
    require('./visualMap/visualEncoding');
...
define('echarts/component/visualMap/ContinuousView', ['require', './VisualMapView', '../../util/graphic', 'zrender/core/util', '../../util/number', '../helper/sliderMove', 'zrender/graphic/LinearGradient', './helper', '../../util/model'], function (require) {
    ...
    var ContinuousView = VisualMapView.extend({
            ...
            _createHandle: function (barGroup, handleIndex, itemSize, textSize, orient) {
                ...
                var handleLabelPoint = [
                        ...
                        orient === 'horizontal' ? handleIndex === 0 ? -(textSize * 1.5) : textSize * 1.5 : handleIndex === 0 ? -textSize / 2 : textSize / 2
                    ];
                var shapes = this._shapes;
                ...
                this._shapes.barGroup.on('mousemove', function (e) {
                    ...
                    if (!self._dragging) {
                        ...
                        var pos = self._applyTransform([
                                e.offsetX,
                                e.offsetY
                            ], self._shapes.barGroup, true, true);
    ...
    function createIndicatorPoints(isRange, halfHoverLinkSize, pos, extentMax) {
        return isRange ? [
            [
                0,
                -mathMin(halfHoverLinkSize, mathMax(pos, 0))
            ],
            [
                HOVER_LINK_OUT,
                0
            ...
            [
                0,
                mathMin(halfHoverLinkSize, mathMax(extentMax - pos, 0))
            ]
        ] : [
            [
                0,
...
define('echarts/component/visualMap/visualEncoding', ['require', '../../echarts', '../../visual/visualSolution', '../../visual/VisualMapping'], function (require) {
    var echarts = require('../../echarts');
...
define('echarts/component/visualMap/VisualMapModel', ['require', '../../echarts', 'zrender/core/util', 'zrender/core/env', '../../visual/visualDefault', '../../visual/VisualMapping', '../../visual/visualSolution', '../../util/model', '../../util/number'], function (require) {
    var echarts = require('../../echarts');
    var zrUtil = require('zrender/core/util');
    var env = require('zrender/core/env');
...
define('echarts/component/visualMap/VisualMapView', ['require', 'zrender/core/util', '../../util/graphic', '../../util/format', '../../util/layout', '../../echarts', '../../visual/VisualMapping'], function (require) {
    var zrUtil = require('zrender/core/util');
    var graphic = require('../../util/graphic');
    var formatUtil = require('../../util/format');
    var layout = require('../../util/layout');
