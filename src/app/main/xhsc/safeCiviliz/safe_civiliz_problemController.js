...
(function(){
  ...
  angular
    .module('app.xhsc')
    .controller('safe_civiliz_problemController',safe_civiliz_problemController);

  /**@ngInject*/
  function safe_civiliz_problemController(remote,$stateParams,$scope,$q,$rootScope,$state,api){
    var vm = this;
    ...
    api.setNetwork(1).then(function(){
      ...
      var sendaResult = $rootScope.$on('sendGxResult',function(){
        $state.go('app.xhsc.sf.sfinfo',{acceptanceItemName:acceptanceItemName,acceptanceItemID:acceptanceItemID,name:vm.RegionFullName,areaId:areaId,projectId:projectId,InspectionId:vm.inspectionId});
      })
