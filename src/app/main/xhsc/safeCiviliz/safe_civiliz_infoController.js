...
(function(){
  ...
  angular
    .module('app.xhsc')
    .controller('safe_civiliz_infoController',safe_civiliz_infoController);

  /** @ngInject*/
  function safe_civiliz_infoController($mdDialog,$stateParams,$state,$scope,remote,utils,xhUtils,api){
    var vm = this;
