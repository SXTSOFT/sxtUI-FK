...
(function () {
  ...
  /** @ngInject */
  function sfDynamicMainController(xhscService,$mdDialog,api,$scope,$q,remote,$state) {
    var vm = this;
    vm.procedure = [];
    vm.create=function () {
      $mdDialog.show({
        controller: ['$scope', 'utils', '$mdDialog', function ($scope, utils, $mdDialog) {
          ...
          function initTheme() {
            ...
            if (!area||!projectName){
              ...
              $scope.subject= projectName+area+ year+"年"+month+"月"+day+"日"+"动态危险源检查";
            }
          }
    ...
    vm.setModule = function (val) {
      $state.go('app.xhsc.sf.sfDynamicBase', {yw: val})
    }
