...
(function () {
  ...
  /** @ngInject */
  function yfMainController(xhscService,$mdDialog,api,$scope,$q,remote,$state,sxt,utils,$mdBottomSheet,authToken,$rootScope) {

    var vm = this;
    $rootScope.$emit("hidebar");
    $rootScope.title="内部验房";
    var token=authToken.getToken();
    vm.href="yf.html?token="+token;
