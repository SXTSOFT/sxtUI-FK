...
(function(){
  ...
  angular
    .module('app.xhsc')
    .directive('selfRecheckPopup',selfRecheckPopup);
  /** @ngInject */
  function selfRecheckPopup(mapPopupSerivce,$timeout,sxt,xhUtils,remote,$q,utils){
    return {
      restrict:'E',
      scope:{
        slideShow:'=',
    ...
    function link(scope,element,attr,ctrl){
      ...
      mapPopupSerivce.set('selfRecheckPopup',{
        el:element,
        scope:scope
      });
      scope.$on('$destroy',function(){
        mapPopupSerivce.remove('selfRecheckPopup');
        $(element).remove();
      });
    }
  }
