...
(function (angular, undefined) {
  ...
  function sxtAreaTf($timeout, sxt, utils,api) {
    ...
    function link(scope, element, attrs, ctrl) {
      ...
      var ran;
      ran = function () {
        if (!scope.show || !scope.data || scope.data.files.length === 0) return;
        if (map) map.remove();
        ...
        map.on('draw:edited', function (e) {
          ...
          layers.eachLayer(function (layer) {
            ...
            api.earthwork.earthwork.update(layer.data.Id, layer.data);
          });
        });
        ...
        map.on('popupclose', function (e) {
          ...
          if (text == '') {
            ...
            json.options.id = json.options.id || utils.uuid();
            layer.data = {
              Id: json.options.id,
              RegionName: text,
